...
#include "game/systems/commandsPlayerMovementSystem/MoveRightCommand.h"

void MoveRightCommand::execute(std::shared_ptr<LocationComponent> comp,
  ...
  dir->direction_ = DirectionComponent::RIGHTWARD;
}
